...
import com.assignment.bookstore.web.UserDetailServiceImpl;

//WebSecurityConfig class contains a method configure(HttpSecurity)
//that defines which URL paths are secured and the path for login form
